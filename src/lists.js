 ...
 *    cons(a, cons(b, cons(c, emptyList)))
 */
var list = f.varArgs(arrayAsList);
...
/**
 * foldR1 implementation. Reduce a list down to a single value.
 *
 * @pram {Function} fn     (rightEval, curVal) -> result
 */
...
function without(list, test, removedFn) {
    ...
    return withoutInner(list, removedFn || f.noop);
...
/* get the first item from the list which matches the given condition */
